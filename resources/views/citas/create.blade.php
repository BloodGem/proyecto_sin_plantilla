            ...
            <div class="col-md-15">
                        ...
                        <form action="{{ route('citas.store')}}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="paciente" type="text" class="form-control @error('paciente') is-invalid @enderror" name="paciente" value="{{ old('paciente') }}" required autocomplete="paciente" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="comentario" type="text" class="form-control @error('comentario') is-invalid @enderror" name="comentario" value="{{ old('comentario') }}" required autocomplete="comentario">

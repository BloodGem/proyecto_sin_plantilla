        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ 'SYSTEMAR' }}
                    <img src="/images/diente.png" width="36">
                </a>
                    ...
                    <ul class="navbar-nav mr-auto">
						<li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                </svg>  Clinica HealdAtom
                            </a>
    
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a href="{{ url('') }}" class="dropdown-item">
                                    
                                    {{ __('Clinica HealVegas') }}
                                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						<div>
                            ...
                            <a href="{{ url('/citas') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
                        ...
                        <div>
                            <a href="{{ url('/pacientes') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                        ...
                        <div>
                            <a href="{{ url('/fichas') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                        ...
                        <div>
                            <a href="{{ url('/carrito') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calculator-fill" viewBox="0 0 16 16">
                        ...
                        <div>
                            <a href="{{ url('') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">
                                ...
                                <a href="{{ url('/gastos') }}" class="dropdown-item">
                                ...
                                <a href="{{ url('') }}" class="dropdown-item">
                                    ...
                                    </svg>  {{ __('Gestión de especialidades') }}
                                </a>
                                ...
                                <a href="{{ url('') }}" class="dropdown-item">
                                    ...
                                    </svg> {{ __('Planificación y sudo de Box/Sillones') }}
                                </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">
                                <a href="{{ url('') }}" class="dropdown-item">
                                    ...
                                    </svg>  {{ __('Agenda online') }}
                                </a>
    
                                <a href="{{ url('/categorias') }}" class="dropdown-item">
                                    ...
                                    </svg>  {{ __('Arancel de precios') }}
                                </a>

                                <a href="{{ url('/motivos') }}" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                        <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                                    </svg>  {{ __('Motivos de ficha') }}
                                </a>

                                <a href="{{ url('/bancos') }}" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank2" viewBox="0 0 16 16">
                                        <path d="M8.277.084a.5.5 0 0 0-.554 0l-7.5 5A.5.5 0 0 0 .5 6h1.875v7H1.5a.5.5 0 0 0 0 1h13a.5.5 0 1 0 0-1h-.875V6H15.5a.5.5 0 0 0 .277-.916l-7.5-5zM12.375 6v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zM8 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2zM.5 15a.5.5 0 0 0 0 1h15a.5.5 0 1 0 0-1H.5z"/>
                                    </svg>  {{ __('Bancos y entidades financieras') }}
                                </a>
                                ...
                                <a href="{{ url('') }}" class="dropdown-item">
                                    ...
                                    </svg>  {{ __('Pagos anulados y pendientes') }}
                                </a>
                        ...
                        <div>
                            <a href="{{ url('/browsers') }}" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="16" height="16" viewBox="0 0 211.618 211.618" style="enable-background:new 0 0 211.618 211.618;" xml:space="preserve">
